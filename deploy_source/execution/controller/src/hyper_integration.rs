...
// Benchmark-derived optimal values for parallel execution
pub const OPTIMAL_BATCH_SIZE: usize = 100;  // Determined from HyperSDK benchmarks
pub const OPTIMAL_THREAD_COUNT: usize = 8;  // Determined from HyperSDK benchmarks
